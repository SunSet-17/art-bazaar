                ...
                <div className="flex justify-between">
                    ...
                    <div>
                        ...
                        <div className="flex items-center py-4 px-2">
                            <svg className="fill-current h-8 w-8 mr-2" width="56" height="55" viewBox="0 0 56 55" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18.3286 8.50221H40.5362V0H55.9999V36.9917H49.4892V14.361H18.3286V8.50221Z" fill="url(#paint0_linear_96_36)"/><path d="M8.60529 37.2221V15.2785H0V0H37.4402V6.43271H14.5351V37.2221H8.60529Z" fill="url(#paint1_linear_96_36)"/><path d="M37.6734 46.4978H15.4637V55H0V18.0083H6.51071V40.639H37.6734V46.4978Z" fill="url(#paint2_linear_96_36)"/><path d="M47.3968 17.7779V39.7215H56V55H18.5598V48.5673H41.467V17.7779H47.3968Z" fill="url(#paint3_linear_96_36)"/><defs><linearGradient id="paint0_linear_96_36" x1="18.3286" y1="18.4958" x2="55.9999" y2="18.4958" gradientUnits="userSpaceOnUse"><stop stop-color="#FFBF1E"/><stop offset="1" stop-color="#FDE4A0"/></linearGradient><linearGradient id="paint1_linear_96_36" x1="18.7201" y1="36.86" x2="18.7201" y2="-0.131658" gradientUnits="userSpaceOnUse"><stop stop-color="#AC54EA"/><stop offset="1" stop-color="#AA86D5"/></linearGradient><linearGradient id="paint2_linear_96_36" x1="6650.49" y1="6582.18" x2="-165.763" y2="6582.18" gradientUnits="userSpaceOnUse"><stop stop-color="#FFBF1E"/><stop offset="1" stop-color="#FDE4A0"/></linearGradient><linearGradient id="paint3_linear_96_36" x1="6722.23" y1="3568.02" x2="6722.23" y2="10261.3" gradientUnits="userSpaceOnUse"><stop stop-color="#AC54EA"/><stop offset="1" stop-color="#AA86D5"/></linearGradient></defs></svg>
                            {/* //todo: 改为引用svg */}
                            <Link href="/">
                    ...
                    <a href="#" className="inline-block font-medium px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-bg hover:bg-white mt-4 lg:mt-0">CONNECT WALLET</a>
                    {/* //todo: 连接钱包 */}
                    </div>
                    ...
                    <button onClick={()=>{document.querySelector(".mobile-menu").classList.toggle("hidden")}} className="outline-none mobile-menu-button">
                        <svg className=" w-6 h-6 text-white hover:text-slate-500 " x-show="!showMenu" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M4 6h16M4 12h16M4 18h16"></path></svg>
                    </button>
                    </div>
